...
『바이브 코딩』 4장 실습으로 만든 앱이다. 클로드에게 PRD를 쓰게 하고, 그 PRD를 5단계 프롬프트로 나눈 뒤, 단계마다 커밋을 남기며 구현하고, 마지막에 브라우저에서 완료 기준을 확인했다.

이전 버전의 README는 강의 노트가 각 시점의 화면을 참조하고 있어 각 시점의 구성을 보존한다.
